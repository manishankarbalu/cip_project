...
parser.add_argument('--load_size', dest='load_size', type=int, default=258, help='scale images to this size')
...
def main(_):
    ...
    with tf.Session() as sess:
        model = gan(sess, image_size=args.fine_size, batch_size=args.batch_size,
